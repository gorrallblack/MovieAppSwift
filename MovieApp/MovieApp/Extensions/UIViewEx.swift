...
extension UIViewController {
    func showToast(_ message: String){
        ...
        messageLbl.frame = CGRect(x: 20, y: window.frame.height - 90, width: labelWidth + 30, height: textSize.height + 30)
    ...
    func showToastFromTop(_ message: String) {
        ...
        messageLbl.font = UIFont.systemFont(ofSize: 16)
        messageLbl.textColor = UIColor.black
        messageLbl.backgroundColor = UIColor.init(hexString: "#F3F9E8")
        
        let textSize:CGSize = messageLbl.intrinsicContentSize
        let labelWidth = min(textSize.width, window.frame.width - 40)
        
        messageLbl.frame = CGRect(x: 20, y: 100, width: labelWidth + 30, height: textSize.height + 30)
        messageLbl.center.x = window.center.x
        messageLbl.numberOfLines = 0
        messageLbl.layer.cornerRadius = messageLbl.frame.height/2
        messageLbl.layer.masksToBounds = true
